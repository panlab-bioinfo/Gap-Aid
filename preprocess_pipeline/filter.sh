...
DESCRIPTION:
This is a script that maps reads to draft assemblies an..d get the overlaps of reads
...
-re|--reliable      The alignment you think are reliable ,format:'MapQ aligned_ratio'.(default:'0 0.4')
