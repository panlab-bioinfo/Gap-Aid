...
### Another choice: Using overlaps and corrected reads generated by hifiasm. (testing)
...
### filter output file
If the file is particularly large,you can use this script.
...
prefix.chr.fa is the scaffold that your input

prefix.chr.fa.infor.txt is the scaffold gap information

prefix_useful.reads.fa is filtered reads

prefix.map.final.paf is the alignments of scaffold and reads

prefix.ovlp.final.paf is the alignments of reads and reads

*.score.txt is the score we use to recommend the reads

*idx is the index of the file, which can speed up file retrieval
