...
### Using overlaps and corrected reads generated by hifiasm.
...
```
<details>
<summary><b>#### Automatic find path(testing)</b></summary>

```
cd Gap-Aid/preprocess/
chmod + x filter.sh
./find_path.py [-h] [-p] [-n] [-i] gap_position map_file map_score ovlp_score
```
```
usage: find_path.py [-h] [-p] [-n] [-i] gap_position map_file map_score ovlp_score

Automatic path finding.

positional arguments:
  gap_position       gap_position file. note: *infor.txt
  map_file           reads map chrosomes paf file. note: *map.final.paf
  map_score          reads map chrosomes score file. note: *map.score.txt
  ovlp_score         reads overlap score file. note: *ovlp.score.txt

options:
  -h, --help         show this help message and exit
  -p , --prefix      The prefix of generated file. default: gap-aid
  -n , --number      The number of nodes selected in each iteration. default: 5
  -i , --iteration   The iteration number you want to find. default: 100
```
</details>
