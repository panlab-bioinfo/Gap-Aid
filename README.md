...
### 1. pipeline.sh: using minimap2 to generate overlaps.
```bash  
version 240720
...
### 2. pipeline_hifiasm.sh: using overlaps and corrected reads generated by hifiasm.
If you have run hifiasm, you can run the following commands to generate the corrected reads and overlaps.
If you want to use this script to process ONT reads, you must ensure they are ONT Simplex R10 reads.(hifiasm >= 0.21.0 (r686))
